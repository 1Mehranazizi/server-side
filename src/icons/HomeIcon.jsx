...
const HomeIcon = ({ className }) => {
  return (
    <svg
      id="Huge-icon_interface_outline_home_03"
      data-name="Huge-icon/interface/outline/home 03"
