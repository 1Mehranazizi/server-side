export const styles = {
  ...
  cartActions: "flex flex-col gap-4",
  quantityRow: "flex items-center justify-between",
  colorBox: "w-[30px] h-[30px] rounded-6px",
  button:
  ...
  colorStart: "flex items-center gap-2",
  priceColor: "text-errorColor font-bold",
};
